...
using DocumentManagement.Infrastructure.Security;
using DocumentManagement.Infrastructure.Security.Providers;
...
namespace DocumentManagement.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("UserInfo")]
        public Core.Models.UserInfoViewModel GetUserInfo()
        {
